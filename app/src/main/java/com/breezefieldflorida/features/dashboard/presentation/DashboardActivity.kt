package com.breezefieldflorida.features.dashboard.presentation
...
import com.breezefieldflorida.*
import com.breezefieldflorida.R
import com.breezefieldflorida.app.*
import com.breezefieldflorida.app.NewFileUtils.browseDocuments
import com.breezefieldflorida.app.NewFileUtils.browsePDFDocuments
import com.breezefieldflorida.app.NewFileUtils.getExtension
import com.breezefieldflorida.app.domain.*
import com.breezefieldflorida.app.types.DashboardType
import com.breezefieldflorida.app.types.FragType
import com.breezefieldflorida.app.types.TopBarConfig
import com.breezefieldflorida.app.uiaction.DisplayAlert
import com.breezefieldflorida.app.utils.*
import com.breezefieldflorida.app.utils.AppUtils.Companion.isProfile
...
import com.breezefieldflorida.features.NewQuotation.*
import com.breezefieldflorida.features.NewQuotation.api.GetQuotRegProvider
import com.breezefieldflorida.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezefieldflorida.features.SearchLocation.SearchLocationFragment
import com.breezefieldflorida.features.SearchLocation.locationInfoModel
import com.breezefieldflorida.features.TA.ViewAllTAListFragment
import com.breezefieldflorida.features.achievement.AchievementFragment
import com.breezefieldflorida.features.activities.presentation.*
import com.breezefieldflorida.features.addAttendence.*
import com.breezefieldflorida.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezefieldflorida.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezefieldflorida.features.addAttendence.model.GetReportToFCMResponse
import com.breezefieldflorida.features.addAttendence.model.GetReportToResponse
import com.breezefieldflorida.features.addAttendence.model.Leave_list_Response
import com.breezefieldflorida.features.addorder.presentation.AddOrderFragment
...
import com.breezefieldflorida.features.addshop.presentation.AddShopFragment
import com.breezefieldflorida.features.addshop.presentation.OTPVerificationDialog
import com.breezefieldflorida.features.addshop.presentation.ScanImageFragment
import com.breezefieldflorida.features.addshop.presentation.ShowCardDetailsDialog
import com.breezefieldflorida.features.alarm.model.AlarmData
import com.breezefieldflorida.features.alarm.presetation.AttendanceReportFragment
import com.breezefieldflorida.features.alarm.presetation.PerformanceReportFragment
import com.breezefieldflorida.features.alarm.presetation.VisitReportDetailsFragment
import com.breezefieldflorida.features.alarm.presetation.VisitReportFragment
import com.breezefieldflorida.features.attendance.AttendanceFragment
import com.breezefieldflorida.features.attendance.api.AttendanceRepositoryProvider
import com.breezefieldflorida.features.attendance.model.AttendanceRequest
import com.breezefieldflorida.features.attendance.model.AttendanceResponse
import com.breezefieldflorida.features.averageshop.presentation.AverageShopFragment
import com.breezefieldflorida.features.avgorder.presentation.AverageOrderFragment
import com.breezefieldflorida.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezefieldflorida.features.beatCustom.TeamBeatListFragment
import com.breezefieldflorida.features.billing.presentation.AddBillingFragment
import com.breezefieldflorida.features.billing.presentation.BillingDetailsFragment
import com.breezefieldflorida.features.billing.presentation.BillingListFragment
import com.breezefieldflorida.features.changepassword.presentation.ChangePasswordDialog
import com.breezefieldflorida.features.chat.model.ChatListDataModel
import com.breezefieldflorida.features.chat.model.ChatUserDataModel
import com.breezefieldflorida.features.chat.model.GroupUserDataModel
import com.breezefieldflorida.features.chat.presentation.*
import com.breezefieldflorida.features.chatbot.presentation.ChatBotFragment
import com.breezefieldflorida.features.chatbot.presentation.ChatBotShopListFragment
import com.breezefieldflorida.features.chatbot.presentation.ReportsFragment
import com.breezefieldflorida.features.chatbot.presentation.SelectLanguageDialog
import com.breezefieldflorida.features.commondialog.presentation.CommonDialog
import com.breezefieldflorida.features.commondialog.presentation.CommonDialogClickListener
import com.breezefieldflorida.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezefieldflorida.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezefieldflorida.features.commondialogsinglebtn.OnDialogClickListener
import com.breezefieldflorida.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezefieldflorida.features.contacts.ActivityDtlsFrag
import com.breezefieldflorida.features.contacts.AddOpptFrag
import com.breezefieldflorida.features.contacts.ContactDtls
import com.breezefieldflorida.features.contacts.ContactGr
import com.breezefieldflorida.features.contacts.ContactsAddFrag
import com.breezefieldflorida.features.contacts.ContactsFrag
import com.breezefieldflorida.features.contacts.SchedulerAddFormFrag
import com.breezefieldflorida.features.contacts.SchedulerViewFrag
import com.breezefieldflorida.features.contacts.TemplateAddFrag
import com.breezefieldflorida.features.contacts.TemplateViewFrag
import com.breezefieldflorida.features.contacts.ViewCrmOpptFrag
import com.breezefieldflorida.features.dailyPlan.prsentation.AllShopListFragment
import com.breezefieldflorida.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezefieldflorida.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezefieldflorida.features.damageProduct.ShopDamageProductListFrag
import com.breezefieldflorida.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezefieldflorida.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezefieldflorida.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezefieldflorida.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezefieldflorida.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezefieldflorida.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezefieldflorida.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezefieldflorida.features.dashboard.presentation.model.ContentListResponseModel
import com.breezefieldflorida.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezefieldflorida.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezefieldflorida.features.device_info.presentation.DeviceInfoListFragment
import com.breezefieldflorida.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezefieldflorida.features.document.DocumentRepoFeatureNewFragment
import com.breezefieldflorida.features.document.presentation.DocumentListFragment
import com.breezefieldflorida.features.document.presentation.DocumentTypeListFragment
import com.breezefieldflorida.features.document.presentation.OpenFileWebViewFragment
import com.breezefieldflorida.features.dymanicSection.presentation.AddDynamicFragment
import com.breezefieldflorida.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezefieldflorida.features.dymanicSection.presentation.DynamicListFragment
import com.breezefieldflorida.features.dymanicSection.presentation.EditDynamicFragment
import com.breezefieldflorida.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezefieldflorida.features.home.presentation.HomeFragment
import com.breezefieldflorida.features.homelocation.presentation.HomeLocationFragment
import com.breezefieldflorida.features.homelocation.presentation.HomeLocationMapFragment
import com.breezefieldflorida.features.know_your_state.KnowYourStateFragment
import com.breezefieldflorida.features.lead.LeadFrag
import com.breezefieldflorida.features.lead.ViewLeadFrag
import com.breezefieldflorida.features.leaderboard.LeaderBoardFrag
import com.breezefieldflorida.features.leaveapplynew.LeaveHome
import com.breezefieldflorida.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezefieldflorida.features.localshops.LocalShopListFragment
import com.breezefieldflorida.features.localshops.LocalShopListMapFragment
import com.breezefieldflorida.features.localshops.NearByShopsMapFragment
import com.breezefieldflorida.features.location.*
import com.breezefieldflorida.features.location.api.LocationRepoProvider
import com.breezefieldflorida.features.location.model.*
import com.breezefieldflorida.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezefieldflorida.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezefieldflorida.features.login.ShopFeedbackEntity
import com.breezefieldflorida.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezefieldflorida.features.login.presentation.LoginActivity
import com.breezefieldflorida.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezefieldflorida.features.logoutsync.presentation.LogoutSyncFragment
import com.breezefieldflorida.features.marketAssist.MarketAssistTabFrag
import com.breezefieldflorida.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezefieldflorida.features.marketAssist.ShopListMarketAssistFrag
import com.breezefieldflorida.features.marketing.presentation.MarketingPagerFragment
import com.breezefieldflorida.features.meetinglist.prsentation.MeetingListFragment
import com.breezefieldflorida.features.member.MapViewForTeamFrag
import com.breezefieldflorida.features.member.model.TeamLocDataModel
import com.breezefieldflorida.features.member.model.TeamShopListDataModel
import com.breezefieldflorida.features.member.presentation.*
import com.breezefieldflorida.features.menuBeat.MenuBeatFrag
import com.breezefieldflorida.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezefieldflorida.features.micro_learning.presentation.MicroLearningListFragment
import com.breezefieldflorida.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezefieldflorida.features.myallowancerequest.MyallowanceRequestFragment
import com.breezefieldflorida.features.myjobs.model.CustomerDataModel
import com.breezefieldflorida.features.myjobs.presentation.*
import com.breezefieldflorida.features.myorder.presentation.MyOrderListFragment
import com.breezefieldflorida.features.myprofile.presentation.MyProfileFragment
...
import com.breezefieldflorida.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezefieldflorida.features.nearbyshops.presentation.BeatListFragment
import com.breezefieldflorida.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezefieldflorida.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezefieldflorida.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezefieldflorida.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezefieldflorida.features.newcollection.CollectionDetailsStatusFragment
import com.breezefieldflorida.features.newcollection.CollectionShopListFragment
import com.breezefieldflorida.features.newcollection.NewCollectionListFragment
import com.breezefieldflorida.features.newcollectionreport.*
import com.breezefieldflorida.features.notification.NotificationFragment
import com.breezefieldflorida.features.orderITC.CartListFrag
import com.breezefieldflorida.features.orderITC.OrderListFrag
import com.breezefieldflorida.features.orderITC.ProductListFrag
import com.breezefieldflorida.features.orderITC.ViewNewOrdHisAllFrag
import com.breezefieldflorida.features.orderITC.ViewNewOrdHistoryFrag
import com.breezefieldflorida.features.orderITC.ViewOrdDtls
import com.breezefieldflorida.features.orderList.NewDateWiseOrderListFragment
import com.breezefieldflorida.features.orderList.NewOrderListFragment
import com.breezefieldflorida.features.orderList.OrderListFragment
import com.breezefieldflorida.features.orderdetail.presentation.OrderDetailFragment
import com.breezefieldflorida.features.orderhistory.ActivityMapFragment
import com.breezefieldflorida.features.orderhistory.OrderhistoryFragment
import com.breezefieldflorida.features.orderhistory.TimeLineFragment
import com.breezefieldflorida.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefieldflorida.features.orderhistory.model.FetchLocationRequest
import com.breezefieldflorida.features.orderhistory.model.FetchLocationResponse
import com.breezefieldflorida.features.orderhistory.model.LocationData
import com.breezefieldflorida.features.pendinglocationinout.PendingOutLocationFrag
import com.breezefieldflorida.features.performance.GpsStatusFragment
import com.breezefieldflorida.features.performance.PerformanceFragment
import com.breezefieldflorida.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezefieldflorida.features.performance.model.UpdateGpsInputParamsModel
import com.breezefieldflorida.features.performanceAPP.OwnPerformanceFragment
import com.breezefieldflorida.features.performanceAPP.PerformanceAppFragment
import com.breezefieldflorida.features.performanceAPP.allPerformanceFrag
import com.breezefieldflorida.features.permissionList.ViewPermissionFragment
import com.breezefieldflorida.features.photoReg.*
import com.breezefieldflorida.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezefieldflorida.features.quotation.presentation.*
import com.breezefieldflorida.features.reimbursement.presentation.*
import com.breezefieldflorida.features.report.presentation.*
import com.breezefieldflorida.features.returnsOrder.*
import com.breezefieldflorida.features.settings.presentation.SettingsFragment
import com.breezefieldflorida.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezefieldflorida.features.shopdetail.presentation.*
import com.breezefieldflorida.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldflorida.features.stock.StockDetailsFragment
import com.breezefieldflorida.features.stock.StockListFragment
import com.breezefieldflorida.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefieldflorida.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezefieldflorida.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezefieldflorida.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezefieldflorida.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezefieldflorida.features.stockCompetetorStock.CompetetorStockFragment
import com.breezefieldflorida.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezefieldflorida.features.survey.SurveyFrag
import com.breezefieldflorida.features.survey.SurveyViewDtlsFrag
import com.breezefieldflorida.features.survey.SurveyViewFrag
import com.breezefieldflorida.features.task.presentation.AddTaskFragment
import com.breezefieldflorida.features.task.presentation.CalenderTaskFragment
import com.breezefieldflorida.features.task.presentation.EditTaskFragment
import com.breezefieldflorida.features.task.presentation.TaskListFragment
import com.breezefieldflorida.features.taskManagement.TaskManagementFrag
import com.breezefieldflorida.features.taskManagement.ViewTaskManagementFrag
import com.breezefieldflorida.features.timesheet.presentation.AddTimeSheetFragment
import com.breezefieldflorida.features.timesheet.presentation.EditTimeSheetFragment
import com.breezefieldflorida.features.timesheet.presentation.TimeSheetListFragment
import com.breezefieldflorida.features.viewAllOrder.CartFragment
import com.breezefieldflorida.features.viewAllOrder.OrderTypeListFragment
import com.breezefieldflorida.features.viewAllOrder.ViewAllOrderListFragment
import com.breezefieldflorida.features.viewAllOrder.ViewCartFragment
import com.breezefieldflorida.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezefieldflorida.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezefieldflorida.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezefieldflorida.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezefieldflorida.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezefieldflorida.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezefieldflorida.features.viewPPDDStock.ViewOutstandingFragment
import com.breezefieldflorida.features.viewPPDDStock.ViewPPDDListFragment
import com.breezefieldflorida.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezefieldflorida.features.viewPPDDStock.ViewStockFragment
import com.breezefieldflorida.features.weather.presentation.WeatherFragment
import com.breezefieldflorida.mappackage.MapActivity
import com.breezefieldflorida.mappackage.MapActivityWithoutPath
import com.breezefieldflorida.mappackage.SendBrod
...
import com.breezefieldflorida.features.NewQuotation.ViewAllQuotListFragment.Companion.shop_name
import com.breezefieldflorida.features.addshop.model.AudioFetchDataCLass
import com.breezefieldflorida.features.contacts.LoanDtlsFrag
import com.breezefieldflorida.features.login.api.opportunity.OpportunityRepoProvider
import com.breezefieldflorida.features.login.model.NewSettingsResponseModel
import com.breezefieldflorida.features.performanceAPP.TargetVSAchvFrag
import com.breezefieldflorida.features.performanceAPP.TargetVSAchvDtlsFrag
...
// Log.w(TAG, errorMessage);
    ...
    override fun loadFragment(mFragType: FragType, addToStack: Boolean, initializeObject: Any) {
        ...
        if ( !mFragType.equals(FragType.LogoutSyncFragment)) {
            Pref.IsAnyPageVisitFromDshboard = false
            println("dasg_tag if")
        } else {
            Pref.IsAnyPageVisitFromDshboard = true
...
// check("")
 ...
 showSnackMessage("Attendance can be added only between 8:00 AM and 11:59 PM")*/
            ...
            R.id.new_target_achievement_tv_menu -> {
                TargetVSAchvFrag.userID = Pref.user_id.toString()
...
// val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezefieldfloridalogsample/log").path);
            //27-09-2021
// val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldfloridalogsample/log").path);
...
// BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath = "/data/user/0/com.breezefieldflorida/files/Fsmlog.html"
        ...
        try {
            ...
            val fileUrl1 = Uri.parse(
                File(
                    ...
                    "xbreezefieldfloridalogsample/log"
                ).path
            );
            val fileUrl2 = Uri.parse(
                File(
                    Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                    "xbreezefieldfloridalogsample/log.bak.1"
                ).path
            );
...
// }, 2500)
 ...
 setTopBarVisibility(TopBarConfig.HOME)
            ...
            FragType.TargetVSAchvDtlsFrag -> {
                if (enableFragGeneration) {
                    mFragment = TargetVSAchvDtlsFrag()
                }
                setTopBarTitle("Target Vs Achievement")
                setTopBarVisibility(TopBarConfig.BACK)
            }
            ...
            FragType.LoanDtlsFrag -> {
                if (enableFragGeneration) {
                    mFragment = LoanDtlsFrag()
                }
                setTopBarTitle("Loan Details")
                setTopBarVisibility(TopBarConfig.BACK)
            }
...
// return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root = File(
                Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                "xbreezefieldfloridalogsample/log" + ".txt"
            )
            if (!root.exists()) {
                root.mkdirs()
            }
