package com.breezefieldflorida.features.commondialogsinglebtn
...
import com.breezefieldflorida.app.domain.ShopVisitCompetetorModelEntity
import com.breezefieldflorida.app.domain.VisitRemarksEntity
...
import com.breezefieldflorida.features.addshop.presentation.ProspectListDialog
import com.breezefieldflorida.features.dashboard.presentation.DashboardActivity
import com.breezefieldflorida.features.dashboard.presentation.VisitMultiContactAdapter
...
import com.breezefieldflorida.features.nearbyshops.model.ProsListResponseModel
...
//                        mListener.onOkClick(tv_remarks_dropdown.text.toString().trim(), nextVisitDate, filePath,et_approxvalue_name.text.toString(),ProsId)
            ...
            audioRecRoot.id,et_audioNW.id ->{
                ...
                audioFileNW = File("/data/user/0/com.breezefieldflorida/files", "recorded_audio${System.currentTimeMillis()}.mp3")
