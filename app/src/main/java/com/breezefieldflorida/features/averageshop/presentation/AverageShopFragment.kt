package com.breezefieldflorida.features.averageshop.presentation
...
import com.breezefieldflorida.features.addshop.presentation.AdapterQuestionList
...
import com.breezefieldflorida.features.returnsOrder.ViewAllReturnListFragment
            ...
            override fun onMultipleImageClick(shop: Any,position: Int) {
                if (AppUtils.isOnline(mContext)) {
                    ...
                    if(shopIsuploaded){
                        ...
                        (mContext as DashboardActivity).showSnackMessage("Please snyc shop First..")
                    }
