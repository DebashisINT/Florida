...
import com.breezefieldflorida.app.utils.AppUtils.Companion.changeAttendanceDateFormatToCurrent
import com.breezefieldflorida.app.utils.FTStorageUtils
import com.breezefieldflorida.app.utils.NotificationUtils
...
import com.breezefieldflorida.features.addshop.model.AssignedToShopListResponseModel
import com.breezefieldflorida.features.addshop.model.QuestionSubmit
...
import com.breezefieldflorida.features.addshop.presentation.*
...
import com.breezefieldflorida.features.location.model.ShopDurationRequestData
...
import com.breezefieldflorida.features.marketing.api.marketingcategorylist.MarketingCatListRepoProvider
import com.breezefieldflorida.features.marketing.model.MarketingCategoryListResponse
...
import com.breezefieldflorida.features.nearbyshops.model.StageListResponseModel
...
import com.breezefieldflorida.features.shopdetail.presentation.AddCollectionDialog
...
import com.breezefieldflorida.features.viewAllOrder.interf.QaOnCLick
...
//                            val uri = Uri.fromFile(file)
                ...
                val path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() +"/breezefieldfloridaApp/SHOPDtls/"
                var pathNew = ""
                val dir = File(path)
                if (!dir.exists()) {
                    dir.mkdirs()
