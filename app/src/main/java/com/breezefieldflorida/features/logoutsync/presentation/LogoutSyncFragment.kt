package com.breezefieldflorida.features.logoutsync.presentation
...
import com.breezefieldflorida.CustomConstants
...
import com.breezefieldflorida.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefieldflorida.features.billing.api.AddBillingRepoProvider
import com.breezefieldflorida.features.billing.model.AddBillingInputParamsModel
...
import com.breezefieldflorida.features.dashboard.presentation.ReasonDialog
...
import com.breezefieldflorida.features.document.model.AddEditDocumentInputParams
import com.breezefieldflorida.features.document.model.DocumentAttachmentModel
...
import com.breezefieldflorida.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezefieldflorida.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezefieldflorida.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefieldflorida.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefieldflorida.features.orderhistory.model.*
...
import com.breezefieldflorida.features.quotation.model.AddQuotInputModel
import com.breezefieldflorida.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldflorida.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefieldflorida.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
import com.breezefieldflorida.features.stock.api.StockRepositoryProvider
import com.breezefieldflorida.features.stock.model.AddStockInputParamsModel
import com.breezefieldflorida.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefieldflorida.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezefieldflorida.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezefieldflorida.features.timesheet.model.AddTimeSheetInputModel
import com.breezefieldflorida.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefieldflorida.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefieldflorida.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefieldflorida.mappackage.SendBrod
import com.breezefieldflorida.widgets.AppCustomTextView
import com.breezefieldflorida.MonitorService
import com.breezefieldflorida.MySingleton
import com.breezefieldflorida.app.AlarmReceiver
import com.breezefieldflorida.features.addshop.model.*
import com.breezefieldflorida.features.addshop.model.assigntopplist.AddShopUploadImg
import com.breezefieldflorida.features.addshop.presentation.ShopExtraContactReq
import com.breezefieldflorida.features.addshop.presentation.multiContactRequestData
...
import com.breezefieldflorida.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezefieldflorida.features.login.model.GetConcurrentUserResponse
...
import com.breezefieldflorida.features.orderITC.SyncDeleteOpptL
import com.breezefieldflorida.features.orderITC.SyncEditOppt
import com.breezefieldflorida.features.orderITC.SyncOppt
import com.breezefieldflorida.features.orderITC.SyncOpptProductL
import com.breezefieldflorida.features.orderITC.SyncOrd
import com.breezefieldflorida.features.orderITC.SyncOrdProductL
import com.breezefieldflorida.features.performance.model.Gps_status_list
import com.breezefieldflorida.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefieldflorida.features.returnsOrder.ReturnProductList
import com.breezefieldflorida.features.returnsOrder.ReturnRequest
import com.breezefieldflorida.features.viewAllOrder.model.NewOrderSaveApiModel
import com.breezefieldflorida.features.viewAllOrder.model.NewStockSync
                                 ...
                                 doAsync {
                                     ...
                                     uiThread {
                                         ...
                                         try {
                                             ...
                                             var audFile = File("/data/user/0/com.breezefieldflorida/files", fileName)
                                             audFile.delete()
                                         }catch (ex:Exception){
                                             ex.printStackTrace()
                                         }
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldfloridalogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldfloridalogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldfloridalogsample/log.zip").path);
